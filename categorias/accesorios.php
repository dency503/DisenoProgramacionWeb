...
<body>
    ...
    <header id="cajacabecera">
     ...
     <!-- *******************************************SUB MENÚ******************************************* -->
                  <li class="menum" ><a href="categorias"><i class="fa-solid fa-caret-down"></i>CATEGORIAS</a>
                        <ul>
                            <li class="ccategoria"><a href="faldas.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">FALDAS</a></li>
                            <li class="ccategoria"><a href="pantalones.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">PANTALONES</a></li>
                            <li class="ccategoria"><a href="zapatos.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">ZAPATOS</a></li>
                            <li class="ccategoria"><a href="vestidos.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">VESTIDOS</a></li>
                            <li class="ccategoria"><a href="blusas.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">BLUSAS</a></li>
                            <li class="ccategoria"><a href="camisas.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">CAMISAS</a></li>
                            <li class="ccategoria"><a href="#p-accesorios?token=<?php echo hash('sha1', KEY_TOKEN); ?>">ACCESORIOS</a></li>
                            <li class="ccategoria"><a href="bolsos.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">BOLSOS</a></li>
                        </ul>
                </li>
   ...
   <div class="slides">
     ...
     <main>
        <div id="p-accesorios" >
        <?php
            $sql = $con->prepare("SELECT idProducto, producto, precio, detalles FROM productos WHERE cantidad=1 AND idCategoria=10");
            $sql->execute();
