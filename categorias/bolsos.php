...
<body>
     ...
     <!-- *******************************************SUB MENÚ******************************************* -->
                  <li class="menum" ><a href="categorias"><i class="fa-solid fa-caret-down"></i>CATEGORIAS</a>
                        <ul>
                            ...
                            <li class="ccategoria"><a href="accesorios.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">ACCESORIOS</a></li>
                            <li class="ccategoria"><a href="#p-bolsos?token=<?php echo hash('sha1', KEY_TOKEN); ?>">BOLSOS</a></li>
                        </ul>
                </li>
   ...
   <div class="slides">
     ...
     <main>
        <div id="p-bolsos" >
            <?php
                $sql = $con->prepare("SELECT idProducto, producto, precio FROM productos WHERE cantidad=1 AND idCategoria=8");
                $sql->execute();
