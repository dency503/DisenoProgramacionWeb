...
<body>
     ...
     <!-- *******************************************SUB MENÚ******************************************* -->
                  <li class="menum" ><a href="categorias"><i class="fa-solid fa-caret-down"></i>CATEGORIAS</a>
                        <ul>
                            ...
                            <li class="ccategoria"><a href="#p-camisas?token=<?php echo hash('sha1', KEY_TOKEN); ?>">CAMISAS</a></li>
   ...
   <div class="slides">
     ...
     <main>
        <div id="p-camisas" >
            <?php
                $sql = $con->prepare("SELECT idProducto, producto, precio FROM productos WHERE cantidad=1 AND idCategoria=4");
                $sql->execute();
