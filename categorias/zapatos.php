...
<body>
     ...
     <!-- *******************************************SUB MENÚ******************************************* -->
                  <li class="menum" ><a href="categorias"><i class="fa-solid fa-caret-down"></i>CATEGORIAS</a>
                        <ul>
                            ...
                            <li class="ccategoria"><a href="#p-zapatos?token=<?php echo hash('sha1', KEY_TOKEN); ?>">ZAPATOS</a></li>
   ...
   <div class="slides">
     ...
     <main>
        <div id="p-zapatos" >
            <?php
                $sql = $con->prepare("SELECT idProducto, producto, precio FROM productos WHERE cantidad=1 AND idCategoria=7");
                $sql->execute();
