...
<body>
        ...
        <div id="cabecera">
           <figure id="logo">
            ...
            <!-- *******************************************MENÚ******************************************* -->
                ...
                <nav class="menu">
                <ul>
                    <li class="menum"><a href="#cajacabecera?token=<?php echo hash('sha1', KEY_TOKEN); ?>">INICIO</a></li>
   ...
   <div class="slides">
        ...
        <!-- *******************************************CUADRO DE ROPA: MUJER, HOMBRE******************************************* -->
  <div class="muestra">
        <div class="cajamujer">
            <div class="imagenMujer">
                <img src="imagenes/mujer/m4.jpg" alt="" class="img1">
            </div>
             <div class="colorCajaM"><a href="secciones/mujer.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">MUJER</a></div>
        </div>
        <div class="cajahombre">
            <div class="imagenHombre">
                <img src="imagenes/hombre/h2.jpg" alt="" class="img1">
            </div>
            <div class="colorCajaH"><a href="secciones/hombre.php?token=<?php echo hash('sha1', KEY_TOKEN); ?>">HOMBRE</a></div>
        </div>
    </div>  
     <!-- *******************************************PRODUCTOS******************************************* -->
     <main>
        <div class="oferta" >
            <?php
                $sql = $con->prepare("SELECT idProducto, producto, precio FROM productos WHERE cantidad=1 AND month(fechaEntrada)=05 LIMIT 8");
                $sql->execute();
        ...
        <div class="Lo-nuevo" >
            <?php
                $sql = $con->prepare("SELECT idProducto, producto, precio FROM productos WHERE cantidad=1 AND month(fechaEntrada)=06 LIMIT 12");
                $sql->execute();
                $resultado = $sql->fetchAll(PDO::FETCH_ASSOC);  
           ?> 
            <h1>Lo más nuevo</h1>
